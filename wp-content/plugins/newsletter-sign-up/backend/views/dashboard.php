                    ...
                    <div class="inside">
                        <form method="post" action="options.php" id="ns_settings_page">
                            ...
                            <table class="form-table">	
                                ...
                                <tbody class="form_rows"<?php if (isset($viewed_mp) && in_array($viewed_mp, array('mailchimp', 'ymlp')) && isset($opts['use_api']) &&    echo ' style="display:none" '; ?>>
